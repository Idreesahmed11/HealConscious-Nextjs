      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          ...
          <div className="w-full lg:flex-1 flex flex-col">
            ...
            <h1 className="text-2xl sm:text-[1.75rem] font-semibold leading-snug mb-3">
            ...
            <div className="text-sm text-gray-600 space-y-1.5 pt-1">
              <p><span className="font-semibold text-gray-800">SKU:</span> <span className="text-gray-500">vertical-ga-01</span></p>
              <p><span className="font-semibold text-gray-800">Category:</span>{" "}

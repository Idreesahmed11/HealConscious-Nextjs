    ...
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <section className="w-full bg-white py-12 px-6 md:px-16 lg:px-24">
        <div className="max-w-5xl mx-auto text-gray-800">
          ...
          <h3 className="text-2xl md:text-3xl font-bold mb-4">1. Introduction</h3>
          <p className="mb-3">
          ...
          <h3 className="text-2xl md:text-3xl font-bold mb-4">2. Information We Collect</h3>
          <p className="mb-3">
          ...
          <h3 className="text-2xl md:text-3xl font-bold mb-4">4. Data Sharing and Disclosure</h3>
          <p className="mb-3">
          ...
          <h3 className="text-2xl md:text-3xl font-bold mb-4">5. Data Security</h3>
          <p className="mb-3">
          ...
          <h3 className="text-2xl md:text-3xl font-bold mb-4">8. Third-Party Links</h3>
          <p className="mb-6">
          ...
          <h3 className="text-2xl md:text-3xl font-bold mb-4">9. Children&apos;s Privacy</h3>
          <p className="mb-6">
          ...
          <h3 className="text-2xl md:text-3xl font-bold mb-4">11. Contact Us</h3>
          <p className="mb-3">

...
const AboutComponent = () => {
  return (
    <div className="w-full font-sans">
      ...
      <div className="bg-[#E9E9E9] py-16 lg:py-6 relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto px-4 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="max-w-[95%]">
            ...
            <p className="text-[#555] text-[16px] leading-[1.6] text-justify font-medium">
             Heal Conscious is an alternate medicine and remedy hub focusing on health, mental health and healthy hollistic living for the new age problems rising with the rise of dot com bubble, social media, and AI advancements. Heal Conscious acts as a creative innovation hub that focuses on mental health along with quirky new innovations. As an alternate medicine and remedy hub that explores in modern and alternate medicine styles like, Yoga, Chinese psychology and medicine, Islamic psychology, Japanese psychology, etc. focusing on global future, and creating products for humanity.
            </p>
          </div>
        </div>
      </div>

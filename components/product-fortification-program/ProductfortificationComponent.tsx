...
const keyFeatures = [
  { title: "28-Day Guided Program", desc: "Structured daily prompts and reflections for measurable growth and healing over the course of 4 weeks." },
  { title: "Expertly Curated", desc: "Crafted by experienced psychologists and coaches specializing in mental health and personal development." },
  { title: "Holistic Healing Approach", desc: "Supports emotional freedom, mental clarity, and a healthier mindset." },
  { title: "Perfect Gift for Loved Ones", desc: "Thoughtful and meaningful present for anyone seeking self-discovery and better mental wellness." },
  { title: "Portable & Easy to Use", desc: "Designed for daily use at home, in therapy, or as part of your personal growth journey." },
];

export default function ProductfortificationComponent() {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          ...
          <div className="w-full lg:flex-1 flex flex-col">
            ...
            <h1 className="text-2xl sm:text-[1.75rem] font-semibold text-black-700 leading-snug mb-3">
            ...
            <button onClick={() => setWishlist(!wishlist)} className="flex items-center gap-2 text-sm mb-5 transition-colors" style={{ color: wishlist ? "#ef4444" : "#9ca3af" }}>
            ...
            <div className="text-sm text-gray-600 space-y-1.5 pt-1">
              <p>
                ...
                <span className="text-gray-500">vertical-ga-01</span>
              </p>
              <p>
                <span className="font-semibold text-gray-800">Category:</span>{" "}
                <Link href="/product-category/guides" className="text-gray-500 hover:text-gray-800 underline transition-colors">Guides</Link>
              </p>
              <p className="flex flex-wrap items-center gap-1">
                <span className="font-semibold text-gray-800">Tags:</span>{" "}
                <Link href="/tag/equipment" className="inline-flex items-center gap-1 text-gray-500 hover:text-gray-800 transition-colors">
                ...
                <Link href="/tag/gymer" className="inline-flex items-center gap-1 text-gray-500 hover:text-gray-800 transition-colors">
                  <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M17.707 9.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-7-7A.997.997 0 012 10V5a3 3 0 013-3h5c.256 0 .512.098.707.293l7 7zM5 6a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" /></svg>
                  gymer
                </Link>
              </p>
          ...
          <div className="flex border-b border-gray-200">
            {["description", "additional", "reviews"].map((tab) => (
              <button key={tab} onClick={() => setActiveTab(tab)}
                ...
                {tab === "reviews" ? "Reviews (12)" : tab === "additional" ? "Additional" : "Description"}
              </button>
            ))}
          </div>
          <div className="py-10 text-gray-600 leading-relaxed text-[15px]">
            {activeTab === "description" && (
              <div className="space-y-5 max-w-3xl">
                ...
                <h4 className="font-bold mb-4 text-gray-900 text-base">Product Description</h4>
                  ...
                  <ul className="space-y-3">
                    {keyFeatures.map((feature) => (
                      <li key={feature.title} className="flex gap-3">
                        ...
                        <span><span className="font-semibold text-gray-800">{feature.title}:</span>{" "}{feature.desc}</span>
                      </li>
                    ))}
                  </ul>
                </div>
            ...
            {activeTab === "additional" && (
              <div className="max-w-2xl">
                <table className="w-full border border-gray-200 text-sm">
                  <tbody>
                    <tr className="border-b border-gray-200"><td className="px-5 py-3.5 font-semibold text-gray-800 bg-gray-50 w-1/3">Weight</td><td className="px-5 py-3.5 text-gray-600">.5 lbs</td></tr>
                    <tr className="border-b border-gray-200"><td className="px-5 py-3.5 font-semibold text-gray-800 bg-gray-50">Dimensions</td><td className="px-5 py-3.5 text-gray-600">10 × 12 × 0.5 in</td></tr>
                    <tr className="border-b border-gray-200"><td className="px-5 py-3.5 font-semibold text-gray-800 bg-gray-50">color</td><td className="px-5 py-3.5 text-gray-600">Blue, Red</td></tr>
                    <tr><td className="px-5 py-3.5 font-semibold text-gray-800 bg-gray-50">size</td><td className="px-5 py-3.5 text-gray-600">Medium, Small</td></tr>
                  </tbody>
                </table>
              </div>
            )}

    ...
    <div className="w-full min-h-screen bg-white font-sans text-gray-800">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-2 text-[14px] md:text-[15px]">
            <p className="text-gray-700">
              ...
              <a href="mailto:contact@healconscious.com" className="hover:underline hover:text-blue-600 transition-all">contact@healconscious.com</a>
            </p>
            <p className="text-gray-700">
              <span className="font-bold">Phone:</span>{' '}
              <a href="https://wa.me/13156549181" target="_blank" rel="noreferrer" className="hover:underline hover:text-green-600 transition-all">+1 (315) 654-9181 (WhatsApp)</a>
            </p>
          </div>
        </section>
      ...
      <div className="fixed bottom-8 right-8">
        <button
          ...
          className="bg-gray-800 text-white p-3 rounded-full shadow-lg hover:bg-black transition-all"
        >

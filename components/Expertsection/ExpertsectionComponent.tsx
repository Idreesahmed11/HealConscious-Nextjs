...
const CareoxExperienceComponent = () => {
...
<section className="w-full py-12 bg-white">
  <h2 className="text-1xl sm:text-2xl font-bold text-gray-900 text-center mb-8">
...
<section className="team-section">
  ...
  <h3 className="team">Mental healthcare squad</h3>
...
export default CareoxExperienceComponent;

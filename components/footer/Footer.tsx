...
const defaultPolicies: FooterLink[] = [
...
export default function Footer({
  ...
  const quickLinks = links
    ? links.filter((_, i) => i < Math.ceil(links.length / 2))
    : defaultQuickLinks;
  ...
  return (
    <footer style={{
      ...
      <div style={{
        ...
        <div>
          <p style={{ fontSize: 13, fontWeight: 700, color: textColor, marginBottom: 14 }}>Quick Links</p>
        ...
        <div>
          <p style={{ fontSize: 13, fontWeight: 700, color: textColor, marginBottom: 14 }}>Our Policy</p>
          <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 9, padding: 0, margin: 0 }}>
            {policies.map((l) => (
              <li key={l.label}>
                <Link href={l.href} style={linkStyle}
        ...
        <div>
          <p style={{ fontSize: 13, fontWeight: 700, color: textColor, marginBottom: 14 }}>Contact Us</p>
          {[
      ...
      {showCopyright && (
        <div style={{
          ...
          <p style={{ fontSize: 14, color: 'gray', margin: 0 }}>
            © 2025-26 {companyName} Inc. All Rights Reserved.
          </p>

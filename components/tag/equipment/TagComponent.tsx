        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 flex items-center justify-between gap-4">
          <div>
            <nav className="text-xs text-gray-500 flex items-center gap-2 mb-3 uppercase tracking-wider font-medium">
              ...
              <span className="text-gray-800">Products tagged “Equipment”</span>
            </nav>
            <h1 className="text-3xl sm:text-4xl font-black text-gray-900 uppercase tracking-wide">Equipment</h1>
          </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-200">
            <div className="flex items-center gap-1">
              <button onClick={() => setViewMode("grid")} className={`p-2 rounded border transition-colors ${viewMode === "grid" ? "border-gray-900 text-gray-900 bg-gray-50" : "border-gray-200 text-gray-400 hover:text-gray-600"}`}>
                <GridIcon />
              </button>
              <button onClick={() => setViewMode("list")} className={`p-2 rounded border transition-colors ${viewMode === "list" ? "border-gray-900 text-gray-900 bg-gray-50" : "border-gray-200 text-gray-400 hover:text-gray-600"}`}>
                <ListIcon />
              </button>
            </div>
              ...
              <div key={product.id} className={`flex ${viewMode === "list" ? "flex-col sm:flex-row gap-4 sm:gap-6" : "flex-col"} border-b border-gray-100 pb-6`}>
                ...
                <div className="flex-1 flex flex-col">
                  <Link href={product.slug}>
                    <h2 className="text-sm font-bold text-gray-800 hover:text-gray-600 transition-colors mb-2 leading-snug">{product.title}</h2>
                  </Link>
                  <p className="text-lg font-bold text-gray-900 mb-2">${product.price.toFixed(2)}</p>
                  {viewMode === "list" && (
                    <p className="text-sm text-gray-500 leading-relaxed mb-3 line-clamp-3">{product.description}</p>
                  )}
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-auto">
                    ...
                    <Link href={product.slug} className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-gray-700 transition-colors">
                      <HeartIcon />
